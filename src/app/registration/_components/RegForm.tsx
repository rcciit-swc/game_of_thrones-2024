...
const RegForm = () => {
  return (
    <form action="" className=" w-[80%]  rounded-2xl px-10 py-10 bg-[#252525]">
        ...
        <input
          ...
          className="rounded-xl w-[80%] border-b border-slate-400 bg-transparent px-5 py-1 placeholder:text-slate-400"
        />
      </div>
