...
const RegForm = () => {
  return (
    <form action="" className="w-screen md:w-[80%] mx-auto  rounded-2xl lg:px-10 py-10 bg-[#252525]">
        ...
        <input
          ...
          className="rounded-xl w-[95%] md:w-[80%] border-b border-slate-400 bg-transparent px-5 py-1 placeholder:text-slate-400"
        />
      </div>
